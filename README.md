...
- [Whiscribe](https://github.com/silentsoft/whiscribe): :clapper: A tool with a UI that transcribes audio files into subtitles using OpenAI's Whisper and runs completely on your local machine.
